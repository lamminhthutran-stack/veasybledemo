...
export const modules: Module[] = [
  {
    ...
    questions: [
      {
        q: "What industry does Veasyble operate in?",
        options: ["Logistics", "Retail visibility", "E-commerce", "Food delivery"],
        answer: 1,
      },
      {
        q: "What is the Executor's task?",
        options: ["Campaign design", "Delivery", "Setup campaign at store", "Brand management"],
        answer: 2,
      },
      {
        q: "What does PoP stand for?",
        options: ["Point of Payment", "Proof of Placement", "Part of Process", "Photo of Place"],
        answer: 1,
      },
      {
        q: "Who assigns tasks to Executors?",
        options: ["Brand", "Retailer", "Veasyble platform", "Executors choose themselves"],
        answer: 2,
      },
      {
        q: "What should an Executor do after completing a task?",
        options: ["Call to report", "Send email", "Submit PoP via app", "Do nothing"],
        answer: 2,
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "What does GPS check-in confirm?",
        options: [
          "Executor has printed materials",
          "Executor is at the correct location",
          "Task is completed",
      ...
      {
        q: "What must be in the selfie?",
        options: ["Only the face", "Clear store sign", "Planogram", "Receipt"],
        answer: 1,
      },
      {
        q: "If you are more than 15 minutes late to check-in?",
        options: [
          "It's fine",
          "Pay is partially deducted",
          "Task is cancelled and surged immediately",
          "Account suspended",
        ],
        answer: 2,
      },
      {
        q: "What is the SOP checklist used for?",
        options: [
      ...
      {
        q: "When the store refuses entry, the Executor should?",
        options: [
          "Leave",
          "Handle it themselves",
          "Raise dispute in app - no pay deduction",
          "Call the brand",
        ],
        answer: 2,
      },
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "Why is the timestamp important?",
        options: [
          "To calculate pay",
          "Confirms photo was taken during check-in",
          "To contact brand",
          "Not important",
        ],
        answer: 1,
      ...
      {
        q: "If PoP photo is rejected due to blur?",
        options: ["Report to Veasyble Team", "Retake immediately on site", "Send email", "Ignore"],
        answer: 1,
      },
      {
        q: "What is photo metadata used for?",
        options: [
          "Decoration",
          "Detect editing or forgery",
          "Save executor name",
          "Calculate money",
        ],
        answer: 1,
      ...
      {
        q: "After successful PoP submission?",
        options: [
          "Receive money immediately",
          "Task moves to Under Review",
          "Executor self-evaluates",
          "Brand contacts",
        ],
        answer: 1,
      },
  ...
  },
  {
    ...
    questions: [
      {
        q: "What happens if you check-in 10 minutes late?",
        options: [
          "Nothing happens",
          "Deduct proportional pay",
      ...
      {
        q: "If you check-in 20 minutes late?",
        options: [
          "Can still work normally",
          "50% pay deduction",
          "Task automatically cancelled and given to another executor (surge)",
          "Only a warning",
        ],
        answer: 2,
      },
      {
        q: "Executor rating is based on?",
        options: [
          "Score decided by Veasyble forever",
          "Only Brand review",
          "Rating from Brand and Retailer (after first job)",
          "Executor self-rates",
        ],
        answer: 2,
      },
      {
        q: "What rating is considered Healthy?",
        options: ["3.0 or above", "3.5 or above", "4.0 or above", "Perfect 5.0"],
        answer: 2,
      },
      {
        q: "When arriving at the store but refused entry for setup, you should?",
        options: [
          "Leave and lose the task",
          "Select 'Store refused entry' in app, keep full pay",
          "Argue with security",
          "Call Brand immediately to complain",
        ],
        answer: 1,
      },
    ],
