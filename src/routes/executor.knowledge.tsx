              ...
              <>
                ...
                <div className="space-y-3">
                  {results.map((article) => (
                    ...
                    >
                      <p className="text-sm font-semibold text-gray-900 mb-2">{article.title}</p>
