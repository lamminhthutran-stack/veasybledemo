    ...
    <div className="space-y-5 max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-3">
          <button className="w-full bg-success text-white font-semibold rounded-[5px] py-3 text-sm">
            {"Approve"}
          </button>
          <button className="w-full bg-orange text-orange-foreground font-semibold rounded-[5px] py-3 text-sm">
            {"Schedule Phone Screen"}
          </button>
          <button className="w-full bg-danger text-white font-semibold rounded-[5px] py-3 text-sm">
            {"Reject"}
          </button>
          <div className="text-[11px] text-muted-foreground text-center pt-2">
            {"Rejection reasons available in dropdown."}
          </div>
        </div>
      </div>
    </div>
...
function Doc({ label }: { label: string }) {
  return (
    <div className="border border-border rounded-[5px] overflow-hidden">
      <div className="h-28 bg-surface flex items-center justify-center text-xs text-muted-foreground">
        {"Preview"}
      </div>
