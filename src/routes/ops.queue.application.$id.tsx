    ...
    <div className="space-y-5 max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-card border border-border rounded-[5px] p-5">
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Doc label={"ID Card"} t={t} />
                <Doc label={"Student / Work Card"} t={t} />
              </div>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <button className="w-full bg-success text-white font-semibold rounded-[5px] py-3 text-sm">{"Approve"}</button>
          <button className="w-full bg-orange text-orange-foreground font-semibold rounded-[5px] py-3 text-sm">{"Schedule Phone Screen"}</button>
          <button className="w-full bg-danger text-white font-semibold rounded-[5px] py-3 text-sm">{"Reject"}</button>
